...
from models import User, db, Product,NewProduct
...
def manage_products():
    ...
    if request.method == 'POST':
        ...
        # new_product = Product(name=product_name, description=product_description)
         # code for add product in new table 
        new_product = NewProduct(name=product_name, description=product_description)
